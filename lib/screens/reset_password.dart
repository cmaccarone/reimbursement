...
class ResetPasswordScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(backgroundColor: kAppBarColor,title: Text('Reset Password'),),
      body:
      Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            Center(child: Text('Reset Password',style: kTitleStyle,)),
            SizedBox(height: 30,),
            SignInTextFields(inputText: 'Email',hideText: false, onChanged: (newValue){
              emailField = newValue;
            }),
            SizedBox(height: 10,),
            SubmitButton(label: 'Send Email',onTapped: () async {
              try {
